...
func (p *ProxyController) Reverse() {
	...
	if err != nil{
		p.JsonError(proxyEntryType,err.Error(),StringMap{"result":StringMap{"success":"fail"}},true)
	}
	p.JsonOK(proxyEntryType,StringMap{"result":StringMap{"success":"success","body":body}},true)
}
